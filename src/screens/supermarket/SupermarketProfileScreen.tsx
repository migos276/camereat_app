...
type Props = NativeStackScreenProps<SupermarchéStackParamList, "SupermarketProfile">

const SupermarketProfileScreen: React.FC<Props> = ({ navigation }) => {
    ...
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <View style={styles.avatarContainer}>
          <MaterialIcons name="local-grocery-store" size={60} color={COLORS.primary} />
        </View>
        <Text style={styles.name}>{supermarket.name}</Text>
        <Text style={styles.email}>{supermarket.email}</Text>
        <View style={styles.statsRow}>
          <View style={styles.statItem}>
            <Text style={styles.statValue}>{supermarket.rating}</Text>
            <Text style={styles.statLabel}>Rating</Text>
          </View>
          <View style={styles.statDivider} />
          <View style={styles.statItem}>
            <Text style={styles.statValue}>{supermarket.totalOrders}</Text>
      ...
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>Supermarket Info</Text>
        <View style={styles.infoCard}>
          <View style={styles.infoRow}>
            <MaterialIcons name="phone" size={20} color={COLORS.primary} />
            <Text style={styles.infoText}>{supermarket.phone}</Text>
          </View>
          <View style={styles.infoRow}>
            <MaterialIcons name="location-on" size={20} color={COLORS.primary} />
            <Text style={styles.infoText}>{supermarket.address}</Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.menuCard}>
          ...
          <TouchableOpacity style={styles.menuItem}>
            <MaterialIcons name="inventory" size={24} color={COLORS.dark} />
      ...
      <View style={styles.versionContainer}>
        <Text style={styles.versionText}>Member since {supermarket.memberSince}</Text>
