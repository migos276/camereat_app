...
type Props = NativeStackScreenProps<SupermarchéStackParamList, "SupermarketHome">

const SupermarketHomeScreen: React.FC<Props> = ({ navigation }) => {
  const stats = {
    todayOrders: 45,
    pendingOrders: 8,
    revenue: 1245.50,
  ...
  const recentOrders = [
    { id: "1", customer: "Alice Johnson", items: 15, total: 89.50, status: "new", time: "2 min ago" },
    { id: "2", customer: "Bob Smith", items: 8, total: 45.00, status: "accepted", time: "5 min ago" },
    { id: "3", customer: "Carol White", items: 22, total: 156.50, status: "ready", time: "8 min ago" },
    { id: "4", customer: "David Brown", items: 5, total: 32.00, status: "pickup", time: "12 min ago" },
  ]
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Supermarket Dashboard</Text>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.statsGrid}>
          ...
          <View style={styles.statCard}>
            ...
            <Text style={styles.statValue}>{stats.revenue.toFixed(0)} FCFA</Text>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate("SupermarketOrders")}>
          ...
          {recentOrders.map((order) => (
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate("SupermarketOrderDetail", { id: order.id })}
            >
              ...
              <View style={styles.orderCustomer}>
                ...
                <Text style={styles.itemsCount}>{order.items} items - {order.total.toFixed(2)} FCFA</Text>
              </View>
        ...
        <View style={styles.quickActions}>
          <TouchableOpacity style={styles.actionButton} onPress={() => navigation.navigate("SupermarketProducts")}>
            <MaterialIcons name="inventory" size={24} color={COLORS.white} />
            <Text style={styles.actionButtonText}>Manage Products</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.actionButton} onPress={() => navigation.navigate("SupermarketOrders")}>
