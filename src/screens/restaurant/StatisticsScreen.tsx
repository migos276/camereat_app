    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <Card style={styles.revenueCard}>
          ...
          <Text style={styles.revenueAmount}>1,240.50 FCFA</Text>
          <View style={styles.revenueBreakdown}>
            <View style={styles.breakdownItem}>
              <Text style={styles.breakdownLabel}>Orders: 42</Text>
            </View>
            <View style={styles.breakdownItem}>
              <Text style={styles.breakdownLabel}>Avg Order: 29.54 FCFA</Text>
            </View>
            <View style={styles.breakdownItem}>
...
{ icon: "shopping-cart", label: "Total Orders", value: "42", color: COLORS.RESTAURANT_PRIMARY },
        ...
        <Card style={styles.topProductsCard}>
          ...
          {[
            { name: "Margherita Pizza", quantity: 28, revenue: "363.72 FCFA" },
            { name: "Carbonara Pasta", quantity: 22, revenue: "329.78 FCFA" },
            { name: "Pepperoni Pizza", quantity: 18, revenue: "269.82 FCFA" },
          ].map((product, idx) => (
