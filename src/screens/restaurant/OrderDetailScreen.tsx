      ...
      <View style={styles.section}>
        ...
        <View style={styles.infoCard}>
          ...
          <View style={styles.totalRow}>
            ...
            <Text style={styles.totalValue}>{order.subtotal.toFixed(2)} FCFA</Text>
          </View>
          <View style={styles.totalRow}>
            <Text style={styles.totalLabel}>Delivery Fee</Text>
            <Text style={styles.totalValue}>{order.deliveryFee.toFixed(2)} FCFA</Text>
          </View>
          <View style={styles.grandTotalRow}>
            <Text style={styles.grandTotalLabel}>Total</Text>
            <Text style={styles.grandTotalValue}>{order.total.toFixed(2)} FCFA</Text>
          </View>
        </View>
      </View>
