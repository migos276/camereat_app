    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <Card style={styles.revenueCard}>
          ...
          <Text style={styles.revenueAmount}>2,150.75 FCFA</Text>
          <View style={styles.revenueBreakdown}>
            <View style={styles.breakdownItem}>
              <Text style={styles.breakdownLabel}>Orders: 35</Text>
            </View>
            <View style={styles.breakdownItem}>
              <Text style={styles.breakdownLabel}>Avg Order: 61.45 FCFA</Text>
            </View>
            <View style={styles.breakdownItem}>
        ...
        <Card style={styles.topProductsCard}>
          ...
          {[
            { name: "Organic Milk", quantity: 42, revenue: "167.58 FCFA" },
            { name: "Whole Wheat Bread", quantity: 35, revenue: "104.65 FCFA" },
            { name: "Fresh Chicken Breast", quantity: 18, revenue: "161.82 FCFA" },
          ].map((product, idx) => (
        ...
        <Card style={styles.categoryCard}>
          ...
          {[
            { category: "Dairy & Eggs", percentage: 28, amount: "602.21 FCFA" },
            { category: "Produce", percentage: 22, amount: "473.16 FCFA" },
            { category: "Meat & Fish", percentage: 25, amount: "537.69 FCFA" },
            { category: "Bakery", percentage: 15, amount: "322.61 FCFA" },
            { category: "Others", percentage: 10, amount: "215.08 FCFA" },
          ].map((item, idx) => (
