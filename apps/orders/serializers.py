...
class CommandeCreateSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        delivery_fee = Decimal(validated_data.pop('delivery_fee', Decimal('0')))
        ...
        total_amount = Decimal(requested_total) if requested_total is not None else (products_amount + delivery_fee)
...
class CommandeDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'operator', 'special_instructions', 'items',
